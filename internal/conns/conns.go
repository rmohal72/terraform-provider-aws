...
func init() {
	...
	serviceData[EventBridge] = &ServiceDatum{AWSClientName: "EventBridge", AWSServiceName: eventbridge.ServiceName, AWSEndpointsID: eventbridge.EndpointsID, AWSServiceID: eventbridge.ServiceID, ProviderNameUpper: "EventBridge", HCLKeys: []string{"eventbridge", "events", "cloudwatchevents"}}
